...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    private void updateWear() {
        ...
        if (cursor.moveToFirst()) {
            ...
            cursor.close();
            //format for metric or imperial units before sending data
            final String highString = Utility.formatTemperature(getContext(), high);
            final String lowString = Utility.formatTemperature(getContext(), low);
            ...
            putDataMapRequest.getDataMap().putLong("randomNumber", GregorianCalendar.getInstance()
                    .getTimeInMillis());
                    ...
                    .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                        ...
                        public void onResult(@NonNull DataApi.DataItemResult dataItemResult) {
                            if (!dataItemResult.getStatus().isSuccess()) {
                                Log.d("WEAR", "Failed to send weather update ");
                            } else {
                                Log.d("WEAR", "Successfully sent weather update "
